...
$(userRowIds[i]).append("<div class=\"col-xs-4\"><img height=\"200\" width=\"200\"id=\"user" + i + "Image\" src=\"" + userListings[i][3] + "\">" + userListings[i][4] + "</div>");
$(userRowIds[i]).append("<div class=\"col-xs-2\">"+ userListings[i][4] +"</div>");
$(userRowIds[i]).append("<div class=\"col-xs-2\">" + userListings[i][2] + " " + statusMessage +"Check out </div>");
